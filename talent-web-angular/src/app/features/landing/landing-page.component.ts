...
const EN = {
  ...
  finalSubtitle: 'Explore how Talent OS powers enterprise talent strategy with real-time execution, visibility, and governance.',
...
const AR = {
  ...
  finalSubtitle: 'اكتشف كيف يدعم Talent OS استراتيجية المواهب في مؤسستك من خلال تنفيذ فعلي ورؤية لحظية وحوكمة متكاملة.',
