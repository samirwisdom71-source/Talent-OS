...
public sealed class CreateMarketplaceOpportunityRequestValidator : AbstractValidator<CreateMarketplaceOpportunityRequest>
{
    public CreateMarketplaceOpportunityRequestValidator()
    {
