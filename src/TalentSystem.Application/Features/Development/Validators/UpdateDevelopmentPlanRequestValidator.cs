...
public sealed class UpdateDevelopmentPlanRequestValidator : AbstractValidator<UpdateDevelopmentPlanRequest>
{
    public UpdateDevelopmentPlanRequestValidator(IValidator<DevelopmentPlanLinkInputDto> linkValidator)
    {
