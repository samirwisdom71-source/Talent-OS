...
public sealed class CreateDevelopmentPlanItemRequestValidator : AbstractValidator<CreateDevelopmentPlanItemRequest>
{
    public CreateDevelopmentPlanItemRequestValidator()
    {
