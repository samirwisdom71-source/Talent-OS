...
public sealed class PerformanceCycleFilterRequestValidator : AbstractValidator<PerformanceCycleFilterRequest>
{
    public PerformanceCycleFilterRequestValidator()
    {
