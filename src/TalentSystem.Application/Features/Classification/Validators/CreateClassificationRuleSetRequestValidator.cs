...
public sealed class CreateClassificationRuleSetRequestValidator : AbstractValidator<CreateClassificationRuleSetRequest>
{
    public CreateClassificationRuleSetRequestValidator()
    {
