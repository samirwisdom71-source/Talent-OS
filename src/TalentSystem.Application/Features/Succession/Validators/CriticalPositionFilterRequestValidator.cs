...
public sealed class CriticalPositionFilterRequestValidator : AbstractValidator<CriticalPositionFilterRequest>
{
    public CriticalPositionFilterRequestValidator()
    {
