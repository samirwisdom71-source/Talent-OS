...
public sealed class CreateSuccessorCandidateRequestValidator : AbstractValidator<CreateSuccessorCandidateRequest>
{
    public CreateSuccessorCandidateRequestValidator()
    {
