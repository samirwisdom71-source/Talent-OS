...
public sealed class CreateCriticalPositionRequestValidator : AbstractValidator<CreateCriticalPositionRequest>
{
    public CreateCriticalPositionRequestValidator()
    {
