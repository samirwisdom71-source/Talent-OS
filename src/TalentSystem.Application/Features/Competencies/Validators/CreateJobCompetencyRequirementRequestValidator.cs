...
public sealed class CreateJobCompetencyRequirementRequestValidator : AbstractValidator<CreateJobCompetencyRequirementRequest>
{
    public CreateJobCompetencyRequirementRequestValidator()
    {
