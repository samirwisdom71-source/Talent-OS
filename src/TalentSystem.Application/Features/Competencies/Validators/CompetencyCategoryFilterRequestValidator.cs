...
public sealed class CompetencyCategoryFilterRequestValidator : AbstractValidator<CompetencyCategoryFilterRequest>
{
    public CompetencyCategoryFilterRequestValidator()
    {
